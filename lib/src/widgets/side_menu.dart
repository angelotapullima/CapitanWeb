        ...
        children: [
          (expanded)
              ? Container(
                  ...
                  decoration: BoxDecoration(
                    color: expanded ? const Color(0xFFDDE7F1) : Colors.transparent,
          ...
          InkWell(
            ...
            child: Container(
              ...
              padding: EdgeInsets.symmetric(vertical: ScreenUtil().setHeight(5), horizontal: ScreenUtil().setWidth(5)),
              ...
              child: Row(
                ...
                children: [
                  Container(
                    ...
                    child: SvgPicture.asset(
                      'assets/svg/home.svg',
                      color: expanded ? const Color(0xff197bbd) : const Color(0xffc7c7c7),
                    ),
                  ),
                  Text(
                    titulo,
